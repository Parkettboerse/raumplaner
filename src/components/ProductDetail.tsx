...
export default function ProductDetail({ product, onBack }: Props) {
  return (
    <div>
      ...
      <div style={{ padding: 20, background: "#2A2A2A", border: "1px solid #333", borderRadius: 20, display: "flex", alignItems: "center", gap: 20, flexWrap: "wrap" }}>
        {product.texture_url && (
      ...
      <a href={product.shop_url} target="_blank" rel="noopener noreferrer" style={{
        ...
        background: "#C8A415", color: "#fff", fontSize: 15, fontWeight: 700,
      ...
      <div style={{ marginTop: 16, display: "flex", flexDirection: "column", gap: 10 }}>
        <div style={{ background: "rgba(39,174,96,0.1)", borderRadius: 14, padding: "14px 18px", fontSize: 14, color: "#888" }}>
          <span style={{ color: "#27AE60", fontWeight: 700 }}>✓</span> Verfügbar und direkt bestellbar.
        </div>
        <div style={{ background: "rgba(200,164,21,0.08)", borderRadius: 14, padding: "14px 18px", fontSize: 14, color: "#888" }}>
        ...
        <div style={{ border: "1px solid #333", borderRadius: 14, padding: "14px 18px", fontSize: 14, color: "#888" }}>
