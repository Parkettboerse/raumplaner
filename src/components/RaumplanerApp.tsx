...
export default function RaumplanerApp() {
  // Step 1: Upload, Step 2: Mark corners, Step 3: Choose floor, Step 4: Preview, Step 5: Product detail
    ...
    <div className="min-h-screen" style={{ backgroundColor: "var(--oak-bg)" }}>
      ...
      <header className="border-b bg-white" role="banner" style={{ borderColor: "var(--grey-lighter)" }}>
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6">
          ...
          <nav className="flex items-center gap-4" aria-label="Hauptnavigation">
            <span className="hidden md:inline-flex items-center rounded-full px-3 py-1 text-xs font-semibold" style={{ backgroundColor: "var(--oak-pale)", color: "var(--oak)" }}>
      ...
      <main className="mx-auto max-w-7xl px-4 py-6 sm:px-6 sm:py-8">
        <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          ...
          <StepIndicator currentStep={currentStep <= 5 ? Math.min(currentStep, 4) : 4} />
        </div>
          ...
          <div className="flex flex-col lg:flex-row">
            ...
            <div className="flex-[65] border-b lg:border-b-0 lg:border-r" style={{ borderColor: "var(--grey-lighter)" }}>
              <div className="p-6 sm:p-8">
                ...
                {/* Step 3: Photo preview (corners set, choosing floor) */}
                      ...
                      <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/70 via-black/40 to-transparent px-5 pb-5 pt-14">
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-sm font-medium text-white">
                            <span className="hidden sm:inline">Boden markiert — Wählen Sie rechts einen Bodenbelag aus →</span>
                            <span className="sm:hidden">Boden markiert</span>
                          </span>
                        </div>
                      </div>
                    </div>
                    <button onClick={scrollToSidebar} className="mt-4 w-full rounded-xl py-2.5 text-center text-sm font-semibold text-white lg:hidden" style={{ backgroundColor: "var(--oak)" }}>
                      Böden anzeigen ↓
                    </button>
                  </div>
                )}

                {/* Step 4: Result or rendering */}
                    ...
                    {error ? (
                      <div className="relative w-full overflow-hidden rounded-xl shadow-lg">
                        ...
                        <div className="absolute inset-0 flex items-center justify-center">
                          <div className="mx-4 max-w-sm rounded-2xl bg-white px-8 py-8 text-center shadow-xl">
                            ...
                            <button onClick={handleTryAnother} className="mt-4 rounded-lg px-4 py-2 text-sm font-semibold text-white" style={{ backgroundColor: "var(--oak)" }}>
                      ...
                      <>
                        ...
                        <div className="mt-5 flex flex-col gap-3 sm:flex-row">
                          ...
                          <button onClick={handleTryAnother} className="flex flex-1 items-center justify-center rounded-xl border py-3 text-sm font-semibold hover:bg-gray-50" style={{ borderColor: "var(--grey-lighter)", color: "var(--dark)" }}>
                            Anderen Boden
                          </button>
            ...
            <div ref={sidebarRef} className="flex-[35] lg:max-h-[650px]">
              ...
              {currentStep <= 2 && (
                <div className="flex h-full flex-col items-center justify-center p-6 text-center opacity-60">
                  ...
                  <p className="font-medium" style={{ color: "var(--dark)" }}>
                    {currentStep === 1 ? "Bitte zuerst ein Foto hochladen" : "Bitte den Boden markieren"}
                  </p>
              ...
              {/* Step 4: Catalog still usable — instant re-render */}
              {currentStep === 4 && (
                <FloorCatalog
                  products={products}
                  ...
                  onFloorSelect={(floor) => {
                    ...
                    setResultImage(null);
                    setRendering(true);
                    // FloorPreview re-renders automatically
                  }}
                  onApply={() => {}}
                />
              )}
      ...
      {/* Hidden FloorPreview — renders when we have all inputs */}
