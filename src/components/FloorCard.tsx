  ...
  return (
    <div onClick={() => onSelect(product)} style={{
      ...
      <div style={{ height: 78, position: "relative", overflow: "hidden" }}>
        ...
        {selected && (
          <div style={{ position: "absolute", top: 6, right: 6, width: 22, height: 22, borderRadius: "50%", background: "#C8A415", color: "#2C2820", display: "flex", alignItems: "center", justifyContent: "center", fontSize: 10, fontWeight: 800 }}>✓</div>
        )}
      </div>
      <div style={{ padding: "9px 11px" }}>
        <div style={{ fontSize: 13, fontWeight: 600, color: "#2C2820" }}>{product.name}</div>
